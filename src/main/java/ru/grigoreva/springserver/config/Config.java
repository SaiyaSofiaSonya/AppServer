...
import ru.grigoreva.springserver.controllers.ClientMessageExchangeController;
...
@EnableWebMvc //  аналогичем mvc: anotation-driven, устанавливает context Spring, чтобы разрешить отправку Controller (@RequestMapping, @Controller)
    ...
    public SpringResourceTemplateResolver templateResolver() {
        ...
        templateResolver.setPrefix("/WEB-INF/api/");  //конфигурируем место, где лежат представления
